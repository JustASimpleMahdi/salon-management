...
>
    ...
    <a href="{{ route('manager.services.index') }}"
        @class(['flex flex-col items-center text-xs font-bold','text-[#8d7366]'=>!request()->routeIs('manager.services.*'),'text-[#6d5246]' => request()->routeIs('manager.services.*')])>
        <svg width="24" height="24" fill="currentColor">
            <path
    ...
    <a href="{{ route('manager.personnels.index') }}"
        @class(['flex flex-col items-center text-xs font-bold','text-[#8d7366]'=>!request()->routeIs('manager.personnels.*'),'text-[#6d5246]' => request()->routeIs('manager.personnels.*')])>
        <svg width="24" height="24" fill="currentColor">
            <path
    ...
    <a href="{{ route('manager.appointments.index') }}"
        @class(['flex flex-col items-center text-xs font-bold','text-[#8d7366]'=>!request()->routeIs('manager.appointments.*'),'text-[#6d5246]' => request()->routeIs('manager.appointments.*')])>
        <svg width="24" height="24" fill="currentColor">
            <path
